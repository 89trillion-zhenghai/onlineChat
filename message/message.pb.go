...
type Message struct {
	...
	MsgType    string   `protobuf:"bytes,1,opt,name=msgType,proto3" json:"msgType,omitempty"`       //消息类型
	MsgContent string   `protobuf:"bytes,2,opt,name=msgContent,proto3" json:"msgContent,omitempty"` //消息内容
	SendName   string   `protobuf:"bytes,3,opt,name=sendName,proto3" json:"sendName,omitempty"`     //用户名
	UserList   []string `protobuf:"bytes,4,rep,name=userList,proto3" json:"userList,omitempty"`     //用户列表
}
...
func (x *Message) GetMsgContent() string {
	if x != nil {
		return x.MsgContent
	}
	return ""
...
func (x *Message) GetSendName() string {
	if x != nil {
		return x.SendName
	}
	return ""
...
var file_message_message_proto_rawDesc = []byte{
	...
	,
